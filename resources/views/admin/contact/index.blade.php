    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 m-auto">
                <div class="card">
                    <div class="card-header">Contact Query</div>
                    <div class="card-body">
                        ...
                        <form method="GET" action="{{ url('/admin/support/contact-query') }}" accept-charset="UTF-8"
