            ...
            <div class="col-xl-12 m-auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('admin/user/address/'.$userAddress->id) }}" method="POST"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-4">
                                    <textarea name="address1" id="Address1" cols="30" rows="3"
                                        ...
                                        value="{{ old('address1') }}">{{ $userAddress->address1 }}</textarea>
                                </div>
                            </div>
                            <!-- /.Address Input Field -->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-4">
                                    <select name="country" id="Country"
                                        ...
                                        <option value="{{ $count->iso3 }}" @if($userAddress->country == $count->iso3) selected @endif> {{ $count->name }} </option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-actions form-group row">
                                <div class="col-xl-4 m-auto">
                                    ...
                                    <input type="submit" value="Update Address" class="btn btn-primary pull-right">
                                </div>
                            </div>
                        </form>
