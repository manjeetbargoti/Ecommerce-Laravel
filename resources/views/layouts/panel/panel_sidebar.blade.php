            ...
            <ul id="menu">
                ...
                <li class="dropdown_menu {{ (request()->is('admin/pages*')) ? 'active':'' }}">
                    ...
                    <ul>
                        ...
                        <li class="{{ (request()->is('admin/pages/category')) ? 'active':'' }}">
                            <a href="{{ url('admin/pages/category') }}">
                                <i class="fa fa-angle-right"></i>
                ...
                <li class="dropdown_menu {{ (request()->is('admin/suppliers*')) ? 'active':'' }}">
                    ...
                    <ul>
                        ...
                        <li class="{{ (request()->is('admin/suppliers/category')) ? 'active':'' }}">
                            <a href="{{ url('admin/suppliers/category') }}">
                                <i class="fa fa-angle-right"></i>
