...
if (isset($messageCache)) { $message = $messageCache; }
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-4">
                                    ...
                                    <div class="help-block">
                                        <span><a href="<?php echo e(asset(config('app.logo'))); ?>" target="_blank"><img
                                                    src="<?php echo e(asset(config('app.logo'))); ?>"></a></span>
                                    </div>
                                </div>
                            </div>
                            <!-- /.Website Logo Field -->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-4">
                                    ...
                                    <div class="help-block">
                                        <s pan><a href="<?php echo e(asset(config('app.favicon'))); ?>" target="_blank"><img
                                                    src="<?php echo e(asset(config('app.favicon'))); ?>"></a></span>
                                    </div>
                                </div>
                            </div>
                            <!-- Website Favicon Field -->
...
<?php echo $__env->make('layouts.panel.panel_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GITHUB\New-Ecom\resources\views/admin/system/options.blade.php ENDPATH**/ ?>