            ...
            <ul id="menu">
                ...
                <li class="dropdown_menu <?php echo e((request()->is('admin/pages*')) ? 'active':''); ?>">
                    ...
                    <ul>
                        ...
                        <li class="<?php echo e((request()->is('admin/pages/create')) ? 'active':''); ?>">
                            <a href="<?php echo e(url('admin/pages/create')); ?>">
                                <i class="fa fa-angle-right"></i> &nbsp; Add New Page
                            </a>
                        </li>
                        <li class="<?php echo e((request()->is('admin/pages/category')) ? 'active':''); ?>">
                            <a href="<?php echo e(url('admin/pages/category')); ?>">
                                <i class="fa fa-angle-right"></i>
                ...
                <li class="dropdown_menu <?php echo e((request()->is('admin/product*')) ? 'active':''); ?>">
                    ...
                    <ul>
                        ...
                        <li class="<?php echo e((request()->is('admin/product/create')) ? 'active':''); ?>">
...
<!-- /.Sidebar ends here --><?php /**PATH D:\GITHUB\New-Ecom\resources\views/layouts/panel/panel_sidebar.blade.php ENDPATH**/ ?>