            ...
            <div class="col-md-9 m-auto">
                <div class="card file_input">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="<?php echo e(url('/admin/product')); ?>" accept-charset="UTF-8"
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    ...
                                    <select name="product_category" class="form-control" id="product_category">
                                        <?php $__currentLoopData = json_decode('{"":" -- Select Category -- ","test1":"test1"}', true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $optionKey => $optionValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($optionKey); ?>"
                                            <?php echo e((isset($product->product_category) && $product->product_category == $optionKey) ? 'selected' : ''); ?>>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <label for="product_category" class="control-label"><?php echo e('Vendor'); ?></label>
                                    <select name="product_category" class="form-control" id="product_category">
                                        <?php $__currentLoopData = json_decode('{"":" -- Select Vendor -- ","test1":"test1"}', true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $optionKey => $optionValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($optionKey); ?>"
                                            <?php echo e((isset($product->product_category) && $product->product_category == $optionKey) ? 'selected' : ''); ?>>
                                            <?php echo e($optionValue); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.panel.panel_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GITHUB\New-Ecom\resources\views/admin/products/create.blade.php ENDPATH**/ ?>