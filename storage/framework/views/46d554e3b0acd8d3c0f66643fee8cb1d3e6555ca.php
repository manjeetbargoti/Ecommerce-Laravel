                        ...
                        <form class="form-horizontal login_validator m-b-20" id="register_valid"
                            ...
                            <div class="common" id="Common">
                                <div class="form-group row">
                                    ...
                                    array('lawyer','client','agent'))->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $roles): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <!-- <div class="form-group row" id="" >
                                    <div class="col-sm-12">
                                        <label for="Lawyer Experience Level"
                                            class="col-form-label"><?php echo e(__('Lawyer Experience Level')); ?></label>
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                                <i class="fa fa-get-pocket text-primary"></i>
                                            </span>
                                            <select name="lawyerlevel" id="lawyerlevel"
                                                class="form-control <?php if ($errors->has('lawyerlevel')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('lawyerlevel'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>"
                                                value="<?php echo e(old('roles')); ?>" required>
...
<?php echo $__env->make('layouts.front.front_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GITHUB\USER-MANAGEMENT\resources\views/auth/register.blade.php ENDPATH**/ ?>